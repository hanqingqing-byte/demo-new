...
function handleInput(event) {
  ...
  if (["mis", "text"].includes(target.name)) {
    ...
    syncFeedbackSubmitState(demoId);
  }
}
...
function syncFeedbackSubmitState(demoId) {
  const draft = getFeedbackDraft(demoId);
  const canSubmit = Boolean(draft.mis.trim() && draft.text.trim() && !ui.feedbackSubmitting[demoId]);
  const forms = document.querySelectorAll(`form[data-demo-id="${CSS.escape(demoId)}"]`);
...
function renderIcon(name) {
  const icons = {
    ...
    "feedback-fab":
      '<svg viewBox="0 0 1024 1024" aria-hidden="true"><path d="M921.637128 466.553333a45.376425 45.376425 0 0 0-45.572099 45.471753v303.335679c0 33.540623-27.269003 60.704264-60.598901 60.704264H208.584045c-33.49045 0-60.699246-27.16364-60.699247-60.704264V208.634218c0-33.540623 27.208796-60.699246 60.699247-60.699247h303.390869a45.356355 45.356355 0 0 0 45.471753-45.471753c0-25.206895-20.269876-45.577116-45.471753-45.577116H178.234421c-67.026057 0-121.34832 54.322263-121.348319 121.398492V845.715406c0 67.081247 54.322263 121.398493 121.348319 121.398492H845.715406c67.081247 0 121.398493-54.317246 121.398492-121.398492v-333.685302a45.426598 45.426598 0 0 0-45.47677-45.476771z" /><path d="M354.416769 684.710379c17.696003 17.696003 46.605662 17.696003 64.296647 0l493.466109-493.355729c17.690986-17.696003 17.690986-46.605662 0-64.301665-17.696003-17.796349-46.605662-17.796349-64.301665 0l-493.461091 493.255383c-17.696003 17.690986-17.696003 46.706008 0 64.402011z" /></svg>',
