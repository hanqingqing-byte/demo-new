...
function renderIcon(name) {
  const icons = {
    ...
    "feedback-fab":
      '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.5 3.5h7a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-10a2 2 0 0 1-2-2v-7" /><path d="m14.5 3.5 4 4" /><path d="M7.5 15.5h5" /><path d="M7.5 11.5h7" /><path d="m4 7 2.5-2.5M6.5 4.5V7H9" /></svg>',
